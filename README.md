# プライバシー強化技術(PETs) ユースケースカタログ

PETsの活用事例に関する公開情報を収集・整理し、検索・閲覧できるWebカタログです。
何か相談事項があれば、ISSUEに記載してください。随時応答・改善します。
...
#### Webアプリから事例を追加する場合
1. Webアプリから「新規作成」あるいは「更新」で作成・更新フォームを開き、項目を記入する
2. 指示に従って、クリップボードに記録されたjsonをGithubに反映する
3. commitする
4. 管理者が確認してmainにマージされると、アプリに反映される

#### ローカルで/Github上で作成する場合
