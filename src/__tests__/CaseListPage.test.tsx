...
const mockCases: Case[] = [
  {
    ...
    privacy_enhancement_method: '方法1',
    safety_assurance_method: '安全性1',
  ...
  },
  {
    ...
    technology_category: ['differential_privacy'],
    review_status: 'human_reviewed',
    summary: '概要2',
    value_proposition: '成果2',
    privacy_enhancement_method: '方法2',
    safety_assurance_method: '安全性2',
